...
import com.crm.mylibrary.data.PagingDataManager;
...
public class MainTabOneFragment extends BaseFragment {
    ...
    private PageingViewAdapter<String, MainActivity> mRecycleAdapter;
...
//        });
        ...
        mRecycleAdapter = new PageingViewAdapter<String, MainActivity>((MainActivity) getActivity(), l, false, true);
    ...
    private void initSwipeRefresh(SwipeRefreshLayout mSwipeRefreshLayout) {
        ...
        this.mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                RxBus.getInstance().send(MainTabOneFragment.this, Events.EVENT_UPDATE_WIDGET, 1000);
            }
        });
    }
